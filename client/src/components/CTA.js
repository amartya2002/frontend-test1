export default () => {
    return (
        <section className="   cta-sec relative max-w-screen-xl mx-auto py-4 px-6 md:px-8">
            <div className=" absolute top-0 left-0 w-full h-full bg-white opacity-40"></div>
            <div className="relative  gap-5 items-center lg:flex">
                <div className=" -mt-5  flex-1 max-w-lg py-5 sm:mx-auto sm:text-center lg:max-w-max lg:text-left ">
                    <h3 className="text-5xl text-gray-800 font-semibold md:text-5xl">
                    ...
                    <a
                        className="mt-5 px-4 py-2 text-white font-medium bg-slate-900 hover:bg-black rounded-full inline-flex items-center "
